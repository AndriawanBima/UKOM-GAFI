...
public class FirstFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        featuredVerModelList.add(new FeaturedVerModel(R.drawable.ver1,"Featured 1","Salad Buah","4.8","08:00-10:00"));
        featuredVerModelList.add(new FeaturedVerModel(R.drawable.ver2,"Featured 2","Egg Pepper","4.8","08:00-10:00"));
        featuredVerModelList.add(new FeaturedVerModel(R.drawable.ver3,"Featured 3","Bread Bluberry","4.8","08:00-10:00"));
